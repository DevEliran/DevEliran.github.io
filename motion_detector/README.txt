...
Hit 'q' for ending the session and right after that a an html file with a graph will open that will show you the times which an object was inside the camera frame. 
